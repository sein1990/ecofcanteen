...
<tr>
	...
	<td>
		...
		<tr>
			...
			<td><input type="date" name="fromDate" placeholder="yyyy-mm-dd" class="inp-form" required/></td>
			<td></td>
		</tr>
                        <tr>
                <th valign="top"><h1>To Date:</h1></th>
			<td><input type="date" name="toDate" placeholder="yyyy-mm-dd" class="inp-form" required/></td>
			<td></td>
		</tr>
		<tr>
...
//                guestTokenReport file = new guestTokenReport();
//                file.GuestReport(fromDate, toDate);
//    
//             }
                %>			
