...
<%@page import="ClassPackage.empAndGuestTokenReport"%>
...
<div id="page-top">
	...
	<div id="top-search">
 	...
 	<!--  end top-search -->
        <h3><center>ECOF CANTEEN</center></h3><div class="clear"></div>
...
<tr>
	...
	<td>
		...
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    <form action="EmpAndGuestReportServlet" method="post">
                    ...
                    if(request.getParameter("search") !=null)
                      {
                        ...
                        empAndGuestTokenReport file = new empAndGuestTokenReport();
                        file.empGuestReport(df1.format(fromDate), df1.format(toDate));
                      }
                %>			
