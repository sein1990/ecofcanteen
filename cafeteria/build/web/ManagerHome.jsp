...
<tr>
	...
	<td>
		...
		<tr>
                <th valign="top"><h1>Emp ID:</h1></th>
			<td><input type="text" name="empID" class="inp-form" required/></td>
			<td></td>
		</tr>
		<tr>
                <th valign="top"><h1>From Date:</h1></th>
			<td><input type="date" name="fromDate" placeholder="dd/mm/yy" class="inp-form" required/></td>
			<td></td>
		</tr>
                        <tr>
                <th valign="top"><h1>To Date:</h1></th>
			<td><input type="date" name="toDate" placeholder="dd/mm/yy" class="inp-form" required/></td>
			<td></td>
		</tr>
		<tr>
